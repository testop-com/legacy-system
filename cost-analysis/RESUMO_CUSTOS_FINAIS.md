# 💰 RESUMO FINAL DE CUSTOS - Moçambique
...
| ----------------- | ------------ | -------------------- |
| **Desenvolvedor** | $800-1,200/mês | Mercado Moçambique   |
...
| --- | --------------------------- | --------- | -------- | ------- | ---------- | --------- | ----------------- |
| 1   | Consolidar (Externa)        | **$250,000** | 18m      | 131%    | 2.2 anos   | 9 ext     | ⚡ RÁPIDA         |
| 2   | Consolidar (Interna)        | **$305,000** | 27m      | 95%     | 2.6 anos   | 8 int     | 🧠 CONHECIMENTO   |
| 3   | Rebuild (Externa - Modular) | **$180,000** | 18m      | 253% 🎯 | 1.4 anos   | 8 ext/mod | ⭐⭐⭐ **MELHOR** |
| 4   | Rebuild (Interna - Modular) | **$270,000** | 32m      | 177%    | 1.8 anos   | 7 int     | ✅ VIÁVEL         |
...
**$250,000** e quer consolidar rápido:
→ **Estratégia 1**
...
- ✅ Baseado em salários mercado Moçambique (Devs: $800-1,200/mês, DBA: $1,000-1,300/mês)
...
1. **💰 MAIS BARATA**: $180,000 (vs $250,000-385K das outras)
...
_Custos baseados em mercado de Moçambique com overhead simplificado ($5,000/módulo). Todas as 4 estratégias são viáveis com ROI positivo._
